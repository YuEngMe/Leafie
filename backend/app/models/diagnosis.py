...
class Diagnosis(Base, UUIDPrimaryKeyMixin, SoftDeleteMixin):
    ...
    symptom_started_on: Mapped[date | None] = mapped_column(Date)
    ...
    diagnosis_provider_response_id: Mapped[str | None] = mapped_column(String(255))
    explanation_provider: Mapped[str | None] = mapped_column(String(100))
    ...
    diagnosis_latency_ms: Mapped[int | None] = mapped_column(Integer)
